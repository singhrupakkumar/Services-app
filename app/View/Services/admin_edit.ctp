 <section class="content">
  ...
  <div class="box-body"> 
		...
		<div class="form-group">
                    <?php 
                    echo $this->Form->input('sub_catid', ['options' => $SubCategory, 'label' => 'Sub Category:', 'class' => 'form-control','id' => "subcat", 'empty' => 'Choose category']);
                    ?> 
                    </div>
                    <div class="form-group">
...
<script>
   ...
   $('#parentcat').on('change',function(){
                    $.ajax({
			type: "POST",
			url: "<?php echo $this->webroot;?>admin/services/subcat",
			data: {
				id: $(this).val() 
			},
			dataType: "json",
