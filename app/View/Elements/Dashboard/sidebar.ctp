    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">      
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li class="active"><?php echo $this->Html->link('Service List', array('controller' => 'services', 'action' => 'index', 'admin' => true), array('class' => 'users_autorizemenu')); ?></li>
					<li class="active"><?php echo $this->Html->link('Add Service', array('controller' => 'services', 'action' => 'add', 'admin' => true), array('class' => 'users_autorizemenu')); ?></li> 
