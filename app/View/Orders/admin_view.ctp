<h2 style="padding-left: 9px;">Order</h2>
<table style="background: #fff;margin: 0 auto;width:98%;" class="table-striped table-bordered table-condensed table-hover">
    <tr>
        <td>Id</td>
...
<h3 style="padding-left: 9px;">Actions</h3>

<?php echo $this->Html->link('Edit Order', array('action' => 'edit', $order['Order']['id']), array('class' => 'btn btn-success edit_order')); ?>
...
<h3 style="padding-left: 9px;">Related Order Items</h3>

<?php if (!empty($order['OrderItem'])): ?>
<table style="margin: 0 auto;width:100%;" class="table-striped table-bordered table-condensed table-hover">
    <tr>
        <th>Id</th>
        <th>Order Id</th>
        <th>Product Id</th>
    ...
    <tr>
        ...
        <td>
            ...
            <?php echo $this->Html->link('Edit', array('controller' => 'order_items', 'action' => 'edit', $orderItem['id']), array('class' => 'btn btn-success btn-xs')); ?>
