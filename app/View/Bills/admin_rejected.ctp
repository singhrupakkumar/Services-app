    ...
    <div class="row">
        <div class="col-xs-12">
		 <div class="box-header">
                    <h3 class="box-title">All Rejected Bills</h3>
                </div>
 ...
 ?>
  <div class='searchByDate'>
    ...
    <tr>
		...
		<td>
        <?php 
         $rejected_date = explode(' ', $user['Bill']['rejected_date']);
         $date1 = str_replace('-', '/', $rejected_date[0]);
        ...
        <?php 
         ...
         echo date('m-d-Y',strtotime($date2)); ?>
       </td>
        <td><?php 
	   ...
	   <td class="actions">
            ...
            <?php echo $this->Form->postLink('Delete Bill', array('action' => 'rejectdelete', $user['Bill']['id']), array('class' => 'btn btn-danger  btn-xs'), __('Are you sure you want to delete # %s?', $user['Bill']['title'])); ?>
        </td>
    </tr>
    <?php endforeach; ?>
    </tbody>
