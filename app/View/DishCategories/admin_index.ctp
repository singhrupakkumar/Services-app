<div class="content">
    ...
    <div class="main-content">
        ...
        <div class="dishCategories index custom_boxed">
                    ...
                    <?php foreach ($dishCategories as $dishCategory): ?>
                        <tr>
                            ...
                            <td class="actions">
                                ...
                                <?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $dishCategory['DishCategory']['id']), array('class' => 'btn btn-success btn-xs')); ?>
