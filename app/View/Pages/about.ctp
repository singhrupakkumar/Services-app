...
<div class="container margin_60_35">
	<div class="row" style=" margin-top:50px;">
             <?php
			 //print_r($staticabout);
			  foreach ($staticabout as $abt){ ?>
		<div class="col-md-6 venue-detailsnew1"> 
			<h3 class="venue-detailsnew"><?php echo $abt['Staticpage']['title']; ?></h3>
			<p >
		...
		<div class="col-md-5 col-md-offset-1 text-right hidden-sm hidden-xs">
			<img src="<?php echo $this->webroot; ?>files/staticpage/<?php echo $abt['Staticpage']['image']; ?>" alt="" class="img-responsive img-responsive1">
		</div>
             <?php }?>
	</div><!-- End row -->
...
<div class="container">
  <div class="row">
      ...
      <p class="newsletter-cta-text">Want recommendations, chef insights, local tips and more sent straight to your inbox?</p>
        ...
        <div class="col-25n"> 
        	 <a href="http://rajdeep.crystalbiltech.com/cart_new/abc/pages/contact" class="newsletter-cta">Yes, Please!</a>
        </div>
  </div><!--row-->
  </div>
  </div>