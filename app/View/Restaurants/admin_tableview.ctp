        ...
        <table class="authors-list">
            <tr>
                ...
                foreach ($rdata as $cartdatas) {
                    ?>
                    <td><a href="http://readyto.com/admin/restaurants/menudetai/<?php echo $cartdatas['Restable']['res_id']; ?>/<?php echo $cartdatas['Restable']['tableno']; ?>"><?php echo $cartdatas['Restable']['tableno']; ?><span class="authors-booked"></span></a></td>
                <?php } ?>
            </tr>
        </table>
    </div>
    ...
    $(document).ready(function () {
        ...
        jQuery('p.add-author').click(function (event) {
            $.post('http://readyto.com/admin/restaurants/addtableresrv', {tno: counter, resid:<?php echo $restaurant['Restaurant']['id']; ?>}, function (d) {
                ...
                var newRow = jQuery('<td><a href="http://readyto.com/admin/restaurants/menudetai/<?php echo $restaurant['Restaurant']['id']; ?>/' + counter + '">' + counter + '</a></td>');
