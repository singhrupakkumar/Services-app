  ...
  <div class="login_outer_frm">
   ...
   <p class="Worry"> Don't Worry! Just fill in your email and we'll help you reset your password </p>
     ...
     <?php echo $this->Form->create('User');   ?>
       <p><label>  Username <i>*</i></label><span> <input type="text" name="data[User][uname]" placeholder="Username"  ></span></p>
       
      </div>
      
   <div class="login_buttonn "><input type="submit" name="submit" value="SEND EMAIL"></div>
   </div>
   	<div class="btm_frm">
    	<a href="http://rajdeep.crystalbiltech.com/cart_new/abc"> Back to Login </a>
