...
<?php echo $this->Form->create('User',array('id'=>'reset'));   ?>
   <p>
       ...
       <span> <input type="password" id="pass5" name="data[User][password]" class="form-control" required></span>
   </p>
   
   <p><label>  Confirm Password <i>*</i></label><span><input type="password" class="form-control" name="data[User][password_confirm]" required></span></p>
