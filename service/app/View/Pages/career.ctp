...
<div class="container margin_60_35">
	<div class="row" style=" margin-top:50px;">
		...
		<div class="col-md-6 venue-detailsnew1"> 
			<h3 class="venue-detailsnew"><?php echo $career['Staticpage']['title']; ?></h3>
			<p>
				<?php echo $career['Staticpage']['description']; ?>
			</p>
			
		
		</div>
		<div class="col-md-5 col-md-offset-1 text-right hidden-sm hidden-xs">
			<img src="<?php echo $this->webroot; ?>files/staticpage/<?php echo $career['Staticpage']['image']; ?>" alt="" class="img-responsive img-responsive1">
		</div>
             <?php }?>
	</div><!-- End row -->
