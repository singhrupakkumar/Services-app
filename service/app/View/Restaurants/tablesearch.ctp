            ...
            <div id="filters_col">
                ...
                <div class="collapse" id="collapseFilters">
                    <div class="filter_type">
                        ...
                        <h6>Type</h6>
                        <ul>
                            <li><label><input type="checkbox" checked class="icheck" value="all">All <small>(<?php echo @count($resdata['Restaurant']); ?>)</small></label></li>
                            <?php foreach ($restauranttype as $d) { ?>
                                <li><label><input type="checkbox"  class="icheck" value="<?php echo $d['RestaurantsType']['id']; ?>"><?php echo $d['RestaurantsType']['name']; ?> <small></small></label></li>           
                            <?php } ?>
                        </ul>
                    </div>
                    <div class="filter_type">
                    ...
                    <div class="filter_type">
                        <h6>Options</h6>
                        <ul class="nomargin">
                            <li><label><input type="checkbox" class="icheck" value="Delivery">Delivery</label></li>
                            <li><label><input type="checkbox" class="icheck" value="Takeaway">Take Away</label></li>
                        </ul>
                    </div>
                </div><!--End collapse -->
            </div><!--End filters col-->
