...
<div class="container margin_60_35">
	<div class="row" style=" margin-top:50px;">
			...
			<h3 class="venue-detailsnew"><?php echo $team['Staticpage']['title']; ?></h3>
			<p>
				<?php echo $team['Staticpage']['description']; ?>
			</p>
			
		
		</div>
			<div class="col-md-5 col-md-offset-1 text-right hidden-sm hidden-xs">
			<img src="<?php echo $this->webroot; ?>img/<?php echo $team['Staticpage']['image']; ?>" alt="" class="img-responsive img-responsive1">
		</div>
             <?php }?>
	</div><!-- End row -->
